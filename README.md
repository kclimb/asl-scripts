...
- Deleting a save file from the "Delete save data" option on the main menu of 999 will break the Start function for 999 full-game runs. To resolve this, load any save file, then go back to the main menu (or just reboot the game). The game has not been friendly to us in our attempts to properly fix this issue.
